...
from leads.views import BlockedDomainViewSet, LeadImportJobViewSet, LeadViewSet, TagViewSet, LeadScrapeJobViewSet
...
router.register(r'lead-scrape-jobs', LeadScrapeJobViewSet, basename='lead-scrape-jobs')
